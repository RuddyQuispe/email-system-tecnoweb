...
create table usuario(
	...
	tipo_usuario char(1) not null	-- S:socio , D:directivo , E:empleado
);
...
create table empleado(
	...
	foreign key (ci_empleado) references usuario(ci)
	on update cascade
	on delete cascade
);
...
insert into usuario values(9719822, 'zuleny', '76431901', 'zuleny.cr@gmail.com', '1', '11235813', 'Avenida Banzer', 'E');
insert into usuario values(9719823, 'stephani', '68629092', 'stephani.hc.97@gmail.com', '1', '11235813', 'Avenida Pirai', 'S');
insert into usuario values (6868161, 'Jose Pereira', '68686965', 'jose@gmail.com', '0','123456', 'Av. La Barranca #45', 'S');

insert into empleado values(9719822, '2021-12-12', '2022-12-12');

insert into socio values(9719823, '12-12-2020', 12, '1', '12-08-2021');
insert into socio values (6868161, '2021-01-08', 45, '1', '2021-01-08');

insert into ingreso(detalle, fecha_ingreso, monto, ci_empleado) values
...
insert into acta_reunion(fecha_reunion,descripcion,ci_empleado) values
...
insert into egreso(detalle,monto,fecha_egreso,actor_receptor,ci_empleado) values
...
insert into pago (fecha_pago,monto_total,comprobante,ci_socio,ci_empleado) values
